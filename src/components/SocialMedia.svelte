...
<div class="social-media" aria-label={heading}>
  ...
  <div class="social-groups">
    <div class="social-group" aria-label="Telegram">
      <span class="social-group-label" aria-hidden="true">
    ...
    <div class="social-group" aria-label="Facebook & Instagram">
