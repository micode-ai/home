...
|---|---|---|---|
| `team-overview` | 1372×1162 / 1372×1128 | **0,733 / 0,733, молчит** | 0,733, молчит |
...
открыты и прочитаны: подписи узлов и подписи рёбер разборчивы, глифы
укладываются в принятую полосу 16–20 px (0,93 × 0,733 от исходных 24–30 px).
Ни одно ребро не наезжает на подпись, ни одна подпись не обрезана.
...
niedeterministyczne, więc nie wpina się go wprost w nic, co wymaga
