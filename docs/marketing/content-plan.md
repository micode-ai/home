...
Строки 1–8 и 10 готовы к публикации. Строки 9 и 11–13 — план: `campaign.json`
и тексты для них ещё не написаны.
...
Строка 10 (`self-improving-agents`) — **последняя строка верха воронки**: все
четыре оставшихся (9, 11, 12, 13) продуктовые. Она же первая строка календаря,
